    ...
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-[#255f85] relative overflow-hidden p-4 select-none">
      ...
      <div className="absolute inset-0 opacity-[0.55] pointer-events-none z-0">
        <svg className="w-full h-full" xmlns="http://w3.org" fill="none" stroke="#ffffff">
          ...
          <g transform="translate(280, 100)" strokeWidth="2" fill="#ffffff">
            <circle cx="20" cy="20" r="18" fill="#255f85" /><path d="M10,20 L30,20 M20,10 L20,30 M13,13 L27,27 M13,27 L27,13" />
          </g>
          <g transform="translate(530, 195)" strokeWidth="2" fill="#ffffff"><path d="M10,25 A 10,10 0 0,1 25,10 A 12,12 0 0,1 48,15 A 10,10 0 0,1 45,30 Z" fill="#255f85" /></g>
          <g transform="translate(280, 360)" strokeWidth="2" fill="#ffffff"><rect x="2" y="2" width="36" height="24" rx="2" fill="#255f85" /></g>
          <g transform="translate(830, 330)" strokeWidth="2" fill="#ffffff"><rect x="0" y="5" width="42" height="26" rx="2" fill="#255f85" /></g>
          <g transform="translate(630, 495)" strokeWidth="2" fill="#ffffff"><circle cx="20" cy="35" r="4" fill="#ffffff" /><path d="M20,35 L20,15 M10,10 Q20,0 30,10" /></g>
          <g transform="translate(1130, 580)" strokeWidth="2" fill="#ffffff"><ellipse cx="20" cy="10" rx="16" ry="6" fill="#255f85" /><path d="M4,10 L4,22 A16,6 0 0,0 36,22 L36,10" fill="#255f85" /></g>
        </svg>
      </div>
      ...
      <div className="w-full max-w-[430px] z-10 flex flex-col items-center">
        <div className="text-center mb-6 select-none font-sans">
          ...
          <p className="text-[34px] font-bold text-white tracking-[0.2em] uppercase m-0 leading-none mt-1 drop-shadow-[0_2px_5px_rgba(0,0,0,0.45)]">Portal</p>
        </div>
        ...
        <div className="w-full bg-[#eef3f7] rounded-sm shadow-[0_20px_45px_rgba(0,0,0,0.4)] overflow-hidden border border-white/10">
          <div className="p-9 space-y-5">
            <div>
              <h2 className="text-[32px] font-semibold text-[#333333] tracking-tight">User Login</h2>
              <p className="text-[#777777] text-sm mt-0.5 font-normal">Sign In to your portal account</p>
            </div>
